        ...
        <link href="<?php echo base_url(); ?>assets/css/est.css" rel="stylesheet">
          ...
          <!--Script para poder cancelar el ingreso de los datos y dejarlos a como estaba-->
                        ...
                        <script type="text/javascript">
                          ...
                          //   window.location.href = 'http://192.168.0.11:8888/BancoMiPistio/index.php/userspda/nuevo?=opcion'+opcion;
                        ...
                        <script type="text/javascript">
                            ...
                            function nombre(){
                              ...
                              window.location.href = 'http://192.168.0.11:8888/BancoMiPistio/index.php/userspda/nuevo?=id'+opcion;
                              ...
                              <form id="registrationForm" name="registrationForm" class="form-horizontal" action="guardar" method="post">
                                           ...
                                           <?php    } ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-xs-12">
                                                    <input type="text" class="form-control" name="dpi" id="dpi" placeholder="Ingrese Dpi"  onchange="return nombre();" required/>
                                                </div>
                                              ...
                                              <!-- <?php
                                                ...
                                                <div class="col-md-4 col-xs-12">
                                                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="" value="" readonly/>
                                                </div>
