                       ...
                       si los datos se actualizan y hacen bien su proceso en el controlador Pda y en el respectivo modelo. -->
                               ...
                               <div class="row">
                                ...
                                <?php    } ?>
                                   ...
                                   <div class="col-md-2">
                                     ...
                                     mostrar la vista-->
                                         <a  href="http://192.168.0.11:8888/BancoMiPistio/index.php/pda/nuevo" class="btn btn-link btn-lg" data-toggle="tooltip" data-placement="right" title="Agregar Nuevo Punto de atención">
                           ...
                           <table  class="table table-striped table-bordered">
                             <!--El nombre de los campos que se van a mostrar en la vista-->
                                  <thead>
                                      <tr>
                                          <th>Correlativo de punto de atención</th>
