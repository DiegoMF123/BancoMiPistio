...
public function guardar(){
  ...
  if (empty($usuario)) {
    ...
    header("Location: http://192.168.0.11:8888/BancoMiPistio/index.php/userspda/nuevo?response=1");
    die();


  }else{
    echo "Error, no se pudieron guardar los datos";
    header("Location: http://192.168.0.11:8888/BancoMiPistio/index.php/userspda/nuevo");
    die();
...
public function updatedata(){
  ...
  header("Location: http://192.168.0.11:8888/BancoMiPistio/index.php/userspda?response=1");
              die();
