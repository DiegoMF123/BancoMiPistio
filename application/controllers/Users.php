...
// si se cumple la funicón para poder guardar los datos, mandamos los respectivos  datos
      if(empty($usuario)){
        ...
        header("Location: http://192.168.0.11:8888/BancoMiPistio/index.php/users/nuevo");
        die();
      }
      ...
      header("Location: http://192.168.0.11:8888/BancoMiPistio/index.php/users/nuevo?response=1");
        die();
        }
...
// si se modifican los datos redireccionará a esta url, si no, no modificará los datos
    header("Location: http://192.168.0.11:8888/BancoMiPistio/index.php/users?response=1");
                die();
